...
<html lang="zxx">
<head>
<title>Scholar Vision an education Category Bootstrap Responsive website Template | Gallery :: w3layouts</title>
<!-- Meta-Tags -->
...
<h1><a class="col-md-4 navbar-brand" href="index.html">SCSIT<span>Salazar Colleges of Science and <br><br>Institute of Technology</span></a></h1>		<div class="col-md-4 top-header-agile-right">
				<ul>
					...
					<a href="images/g1.jpg" class="lsb-preview" data-lsb-group="header">
						<div class="w3layouts_news_grid">
							...
							<div class="w3layouts_news_grid_pos">
								<div class="wthree_text"><h3>School Vision</h3></div>
							</div>
						</div>
					</a>
				</div>
