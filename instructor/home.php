...
<?php
		$instructor_query=mysql_query("select * from instructor where instructor_id = '$session_id'")
		or die(mysql_error());
...
<thead>
        <tr>
            ...
            <th style="font-size: 14px;">Subject Code</th>
...
<?php
        $a = 0;
        $query = mysql_query("select * from subject where instructor_id = '$session_id'") or die(mysql_error());
        while ($subject_row = mysql_fetch_array($query)) {
            ...
            <tr>
                ...
                <td style="font-size: 14px;"><?php echo $subject_row['title'] ?></td>
                <td style="font-size: 14px;"><a href="load.php<?php echo '?subject_id=' . $id; ?>" title="View Students" style="text-decoration: none;">View Students</a></td>
  </tr>
  <?php
       } 
        ?>
