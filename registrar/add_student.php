...
and year_level='$year_level' and semester='$semester' and schoolyear='$schoolyear' ")or die(mysql_error());
	...
	<?php }else{
mysql_query("INSERT into enrollment (`firstname`,`middlename`,`lastname`,`age`,`gender`,`birthday`,`birthplace`,`address`,`status`,`civilstatus`,`nationality`,`religion`,`email`,`contact`,`year_level`,`semester`,`schoolyear`,`course`) VALUES ('$firstname','$middlename','$lastname','$age','$gender','$birthday','$birthplace','$address','$status','$civilstatus','$nationality','$religion','$email','$contact','$year_level','$semester','$schoolyear','$course')")or die(mysql_error());
?>
	<script>
...
<?php require_once('../modal/edit_profile.php');?>
