...
<div class="well">
    ...
    <button type="button" class="btn btn-default" data-toggle="modal" data-target="#add_subject"><i
    ...
    <div class="row-fluid">
        ...
        <form method="POST" class="form-inline" action="sort_subject.php">
            ...
            <button type="submit" name="submit" class="btn btn-default"><i class="glyphicon glyphicon-check"></i>&nbsp;Submit
            </button>
        </form>
    </div>
    <div class="row-fluid">
        <input style="color:red; float:right; width:300px;" type="text" id="myInput" onKeyUp="myFunction()"
               placeholder="Search for Subject Title.." class="form-control">
    </div>
    <br><br>
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="myTable">
        ...
        while ($row = mysql_fetch_array($user_query)) {
            ...
            <td width="100">
                <a href="#edit_subject<?php echo $id; ?>" title="Edit" data-toggle="modal"
                   style="text-decoration: none;">Edit</a>
                <?php include('../modal/edit_subject.php'); ?>
            </td>
            </tr>
        <?php } ?>
