...
$result=mysql_query("UPDATE enrollment SET firstname='$firstname',middlename='$middlename',lastname='$lastname',age='$age',gender='$gender',birthday='$birthday',birthplace='$birthplace',address='$address',civilstatus='$civilstatus',nationality='$nationality',religion='$religion',contact='$contact',email='$email',year_level='$year_level',semester='$semester',schoolyear='$schoolyear',status='enrolled',course='$course' WHERE student_id='$student_id'") or die(mysql_error());
if($result){?>
    ...
    <div class="form-group">
      <div class="row">
       ...
       <div class="col-md-6" style="text-align: right">
          <button class="btn btn-info" name="submit" type="submit"><i class="fa fa-save"></i>&nbsp;Save and Update</button>
        </div>
      </div>
    </div>
  </form>
